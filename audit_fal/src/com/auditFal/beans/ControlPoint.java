...
public class ControlPoint {
	...
	public static ArrayList<ControlPoint> parseToArrayList(JSONArray jsonArray) {
		ArrayList<ControlPoint> controlPointsList = new ArrayList<>();
		
		@SuppressWarnings("unchecked")
		Iterator<JSONObject> iterator = jsonArray.iterator();
        while (iterator.hasNext()) {
        	controlPointsList.add(ControlPoint.parse(iterator.next()));
        }
        
        return controlPointsList;
	}
	
	public static ControlPoint parse(JSONObject jsonObject) {
